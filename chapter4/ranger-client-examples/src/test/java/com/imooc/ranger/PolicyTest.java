...
public class PolicyTest {
    ...
    public static final String ranger_url = "http://47.108.140.82:6080";
    ...
    public void policyTest(){
        RangerClientConfig rangerClientConfig = RangerClientConfig.builder().connectTimeoutMillis(1000).readTimeoutMillis(1000).level(Logger.Level.BASIC)
                .authConfig(RangerAuthConfig.builder().username("admin").password("imooc@123").build())
        ...
        PolicyResource policyResource = PolicyResource.builder().values(Arrays.asList("/testdir2")).isRecursive(true).build();
