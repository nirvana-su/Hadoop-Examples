    ...
    <el-dialog title="插件管理" :visible.sync="dialogFormVisible">
      <el-form :model="form" v-loading="loading">
        ...
        <el-form-item label="文件" :label-width="formLabelWidth">
          <el-input v-model="form.file" type="file" value="" id="file" @change="beforeupload"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    beforeupload (e) {
      // 2.1，重新写一个表单上传的方法
      this.param = e.target.files[0]
      // this.param.append('file', file) // 把单个图片重命名，存储起来（给后台）
      return false
    },
    addPlugin () {
